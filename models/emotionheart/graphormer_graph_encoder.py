...
class GraphormerGraphEncoder(nn.Module):
    ...
    def forward(
        ...
        use_attn_bias: Optional[torch.Tensor] = True,
        n_modalities = 3
    ):
        is_tpu = False
        ...
        attn_bias = self.graph_attn_bias(batched_data) if use_attn_bias else None
...
class GraphormerSpecificGraphEncoder(nn.Module):
    def __init__(
        self,
        num_nodes,
        num_speakers,
